...
internal sealed class AssignmentService(ApplicationDbContext db, IInboxRealtimeNotifier notifier) : IAssignmentService
{
    public Task<Result> AssignAsync(int? tenantId, int conversationId, string targetAppUserId, string byAppUserId, string? reason, CancellationToken cancellationToken = default) =>
        AssignInternalAsync(tenantId, conversationId, targetAppUserId, reason, cancellationToken);
    ...
    private async Task<Result> AssignInternalAsync(int? tenantId, int conversationId, string targetAppUserId, string? reason, CancellationToken cancellationToken)
    {

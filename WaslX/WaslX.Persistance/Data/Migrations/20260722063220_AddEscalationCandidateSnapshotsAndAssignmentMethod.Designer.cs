...
namespace WaslX.Persistance.Data.Migrations
{
    ...
    [Migration("20260722063220_AddEscalationCandidateSnapshotsAndAssignmentMethod")]
    partial class AddEscalationCandidateSnapshotsAndAssignmentMethod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaslX.Domain.Entities.AiAgentNumberSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaxConversationMessages")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AiAgentNumberSettings");
                });
            ...
            modelBuilder.Entity("WaslX.Domain.Entities.Escalation", b =>
                {
                    ...
                    b.Property<DateTime?>("RecommendationGeneratedAtUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WaslX.Domain.Entities.EscalationCandidateSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EscalationCandidateSnapshots");
                });
            ...
            modelBuilder.Entity("WaslX.Domain.Entities.MessageClassification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MessageClassifications", (string)null);
                });
            ...
            modelBuilder.Entity("WaslX.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEW4v87x6SyxpbUDtgBGjCRTMCjEIgyFcBiXcJU6pCEPAU1UE7V7hjoHfJnlIKHwLw==",
            ...
            modelBuilder.Entity("WaslX.Domain.Entities.EscalationCandidateSnapshot", b =>
                {
                    b.HasOne("WaslX.Domain.Entities.Escalation", "Escalation")
                        .WithMany("CandidateSnapshots")
            ...
            modelBuilder.Entity("WaslX.Domain.Entities.Escalation", b =>
                {
                    b.Navigation("CandidateSnapshots");
                });

...
public interface IWhatsAppService
{
    ...
    Task<Result<SendMessageResult>> SendTextAsync(int? tenantId, string toPhone, string text, int? senderUserId = null, WaslX.Domain.SharedEnums.SenderType senderType = WaslX.Domain.SharedEnums.SenderType.Agent, CancellationToken cancellationToken = default);
    ...
    Task<Result<SendMessageResult>> SendTemplateAsync(int? tenantId, string toPhone, string templateName, string languageCode, TemplateSendParameters? parameters = null, int? senderUserId = null, WaslX.Domain.SharedEnums.SenderType senderType = WaslX.Domain.SharedEnums.SenderType.Agent, CancellationToken cancellationToken = default);
    ...
    Task<Result<SendMessageResult>> SendMediaAsync(
        ...
        string mimeType, int? senderUserId = null, WaslX.Domain.SharedEnums.SenderType senderType = WaslX.Domain.SharedEnums.SenderType.Agent, CancellationToken cancellationToken = default);
}
